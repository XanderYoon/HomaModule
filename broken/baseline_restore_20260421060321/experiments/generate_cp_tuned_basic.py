...
MULTIPLEX_RE = re.compile(r"--multiplex_sessions: ([^, ]+)")
...
def build_caption(num_nodes, multiplex_sessions, pool_size, tfo):
    ...
    return (
        ...
        % (num_nodes or "unknown", multiplex_sessions or "unknown",
...
def main():
    ...
    multiplex_sessions = read_cperf_option(run_dir, MULTIPLEX_RE)
    ...
    lines.extend([
        ...
        "## Caption",
        "",
        build_caption(num_nodes, multiplex_sessions, pool_size, tfo),
        "",
    ])
