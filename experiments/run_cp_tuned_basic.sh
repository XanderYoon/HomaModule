...
HTTP2_SESSIONS="${HTTP2_SESSIONS:-4}"
...
Environment overrides:
  ...
  HTTP2_SESSIONS, POOL_SIZE, TFO, LOG_ROOT, LOCAL_RESULTS_DIR,
...
ssh "$NODE0_ALIAS" "bash -lc 'cd $REMOTE_REPO_DIR/util && timeout $TIMEOUT_SECONDS ./cp_tuned_basic -n $NUM_NODES -s $RUN_SECONDS --tfo $TFO --http2-sessions $HTTP2_SESSIONS --pool-size $POOL_SIZE -l $LOG_DIR'" \
