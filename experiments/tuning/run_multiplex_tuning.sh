...
VARIANT_VALUE="${MULTIPLEX_SESSIONS:-2,4,8}"
VARIANT_HELP_NAME="MULTIPLEX_SESSIONS"
VARIANT_HELP_TEXT="Comma-separated max concurrent logical streams per shared TCP session for the multiplexing variants"
